...
export const HappyCustomerBg = () => {
  return (
    <>
      {/* Sliding Carousel Background */}
      <div className="absolute inset-0 z-0 overflow-hidden bg-[#001429]">
        {/* Row 1 - slides left */}
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#001429]/80 via-[#001429]/40 to-[#001429]/80 z-[1]" />
