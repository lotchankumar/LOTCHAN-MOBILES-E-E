...
export const TechnicianLayout = () => {
  ...
  const navItems = [
    { name: 'Repairs', path: '/technician/repairs', icon: <Wrench className="w-5 h-5" /> },
  ];
  ...
  return (
    <div className="pos-theme">
      ...
      <aside className={`fixed left-0 top-16 h-[calc(100vh-64px)] w-64 flex flex-col z-40 pos-sidenav transition-transform duration-300 ${
        ...
        <div className="p-6">
          <h2 className="text-lg font-semibold text-[#d2e4ff]">Repair Center</h2>
          <p className="text-[10px] uppercase tracking-widest text-slate-500">Technician</p>
        </div>
