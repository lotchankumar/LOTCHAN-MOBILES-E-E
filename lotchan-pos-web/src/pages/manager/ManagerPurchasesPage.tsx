  ...
  return (
    <div className="space-y-6 pos-fade-in">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-[#d2e4ff]">Purchases Management</h2>
        <button
          onClick={() => {
      ...
      {showForm && (
        <div className="pos-glass rounded-xl p-6">
          <h3 className="text-lg font-medium text-[#d2e4ff] mb-6">Record New Purchase</h3>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                {isNewSupplier ? (
                  <div className="space-y-3 p-3 bg-[#0c2b49] rounded-lg border border-white/10">
                    <input
                      type="text"
                    ...
                    <button 
                      ...
                      className="w-full pos-btn-primary py-1.5 px-3 text-sm font-medium"
                    >
                      Save Supplier
                    </button>
                  </div>
              ...
              <div>
                <label className="block text-sm font-medium text-slate-400 mb-2 mt-7">
                  Invoice Number
                </label>
                <input
                  type="text"
            ...
            {/* Add Item Section */}
            <div className="bg-[#0c2b49] p-4 rounded-lg mb-6">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4 gap-4">
                <h4 className="text-sm font-medium text-[#d2e4ff] flex items-center gap-2">
                  ...
                  {(formData.items.length > 0 || (formData.spareItems && formData.spareItems.length > 0)) && (
                    <button
                      ...
                      className="text-xs px-2 py-1 bg-blue-500/10 text-primary rounded-md hover:bg-blue-500/20 transition-colors"
                    >
                ...
                {showAddItemSection && (
                  <div className="flex gap-4 items-center">
                    <select 
                      ...
                      className="pos-input sm:text-sm py-1 h-auto"
                    >
                    ...
                    {isNewCategory ? (
                      <div className="flex gap-2">
                        ...
                        <button 
                          ...
                          className="pos-btn-primary px-3 py-1 text-xs"
                        >
                          Add
                        </button>
                      </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mb-2">
                    <select
                      ...
                      className="pos-input sm:text-sm sm:w-1/3"
                    >
                  ...
                  <div className="relative">
                    ...
                    {showProductDropdown && filteredProducts.length > 0 && (
                      <div className="absolute z-10 mt-1 w-full bg-[#00213d] shadow-lg rounded-md border border-white/10">
                        {filteredProducts.map((product) => (
                          <button
                            key={product.id}
                            type="button"
                            onClick={() => handleProductSelect(product)}
                            className="w-full text-left px-4 py-2 hover:bg-[#0c2b49] focus:outline-none"
                          >
                            <div className="font-medium text-[#d2e4ff]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 border-t border-white/10 pt-4">
                <div>
                  <label className="block text-sm font-medium text-slate-400 mb-2">
                    Quantity
                  </label>
                  ...
                  isNewProduct ? (
                    <>
                      ...
                      <button
                        ...
                        className="pos-btn-secondary py-2 px-4 text-sm font-medium"
                      >
                        Add Without Saving
                      </button>
                    </>
            ...
            {(formData.items.length > 0 || (formData.spareItems && formData.spareItems.length > 0)) && (
              <div className="mb-6">
                <h4 className="text-sm font-medium text-slate-400 mb-4">Items in Purchase</h4>
                <div className="bg-[#00213d] border border-white/10 rounded-lg overflow-hidden">
                  <table className="min-w-full divide-y divide-white/5">
                    ...
                    <tbody className="bg-[#00213d] divide-y divide-white/5">
                        ...
                        return (
                          <tr key={`prod-${index}`}>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className="px-2 py-1 bg-blue-500/10 text-primary rounded text-xs font-medium">Product</span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#d2e4ff]">
                      ...
                      {formData.spareItems && formData.spareItems.map((item, index) => {
                        ...
                        return (
                          <tr key={`spare-${index}`}>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className="px-2 py-1 bg-[#0c2b49] text-[#d2e4ff] rounded text-xs font-medium border border-white/10">Spare Part</span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm font-medium text-[#d2e4ff]">
                    ...
                    <tfoot className="bg-[#0c2b49]">
                      <tr>
                        <td colSpan={4} className="px-6 py-4 text-sm font-medium text-[#d2e4ff] text-right">
                          Grand Total:
                        </td>
                        <td colSpan={2} className="px-6 py-4 text-lg font-bold text-[#d2e4ff]">
      ...
      {/* Purchases History */}
      <div className="pos-glass rounded-xl p-6">
        <h3 className="text-lg font-medium text-[#d2e4ff] mb-6">Purchase History</h3>
        
        {loading ? (
          <div className="text-center py-8">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary mx-auto"></div>
            <p className="mt-4 text-sm text-slate-400">Loading purchases...</p>
          </div>
        ) : unifiedPurchases.length === 0 ? (
          <div className="text-center py-8">
            <ShoppingCart className="mx-auto h-12 w-12 text-slate-400" />
            <p className="mt-2 text-sm text-slate-400">No purchases recorded yet.</p>
          </div>
        ) : (
            ...
            <table className="min-w-full divide-y divide-white/5">
              ...
              <tbody className="bg-[#00213d] divide-y divide-white/5">
                {unifiedPurchases.map((purchase) => (
                  <tr key={purchase.invoiceNo} className="hover:bg-[#0c2b49]">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-[#d2e4ff]">
                        ...
                        {purchase.items.map((item: any, index: number) => (
                          <div key={index} className="flex items-center">
                            <span className="text-slate-400">
                              {item.type === 'SPARE' && <span className="mr-1 inline-block text-[10px] bg-[#0c2b49] border border-white/10 px-1 rounded">SPARE</span>}
                              {item.name} ({item.sku})
                            </span>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-[#d2e4ff]">
